...
export default async function handler(req, res) {
  ...
  const redirectUri = "https://www.milfymadness.com/api/auth/milfymadness/callback"; // Make sure this matches your registered URI
  ...
  try {
    ...
    await fetch(`http://www.milfymadness.com/api/auth/saveProfileFirestore`, {
      method: 'POST',
      headers: {
