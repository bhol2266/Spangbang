    ...
    return (
        <>
            ...
            <Head>
                ...
                <title>{`${capitalizeFirstLetter(pornstarname.replace('+', " ").replace("+", " "))} Porn Videos ${getcurrentyear()} - MilfyMadness | ${currentPageNumberURL}`}</title>
                ...
                <link rel="canonical" href={`https://www.milfymadness.com/pornstar/${code}/${pornstarname}/page/${page}`} />
