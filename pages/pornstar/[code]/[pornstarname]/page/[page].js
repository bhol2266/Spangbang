    ...
    return (
        <>
            ...
            <Head>
                ...
                <title>{`${capitalizeFirstLetter(pornstarname.replace('+', " ").replace("+", " "))} Porn Videos} - SpankBang | ${currentPageNumberURL}`}</title>
                ...
                <meta property="og:title" content={`${capitalizeFirstLetter(pornstarname.replace('+', " ").replace("+", " "))} Porn Videos} - SpankBang`} />
                ...
                <meta name="twitter:title" content={`${capitalizeFirstLetter(pornstarname.replace('+', " ").replace("+", " "))} Porn Videos} - SpankBang`} />
                ...
                <link rel="canonical" href={`https://www.spankbang.gg/pornstar/${code}/${pornstarname}/page/${page}`} />
            ...
            <div>
                ...
                <div className=" mb-6 relative h-[240px] sm:h-[290px] md:h-[260px] lg:h-[290px] xl:h-[300px] 2xl:h-[350px] 3xl:h-[370px] ">
                    <div>
                        ...
                        <div className='flex flex-col items-start mt-auto sm:mt-4 ml-[170px] lg:ml-[200px] 2xl:ml-[210px]'>
                            ...
                            <div className=''>
                                ...
                                <span className='text-white font-poppins text-[12px] lg:text-[14px]'>  {pornstarInformation.videos}</span>
                            </div>

                            <div>
                                <span className='text-gray-400 font-poppins text-[12px] lg:text-[14px]'>Views : </span>
                                <span className='text-white font-poppins text-[12px] lg:text-[14px]'>{pornstarInformation.views}</span>
                            </div>

                            <div>
                                <span className='text-gray-400 font-poppins text-[12px] lg:text-[14px]'>Subscribers : </span>
                                <span className='text-white font-poppins text-[12px] lg:text-[14px]'>{pornstarInformation.subscribers}</span>
                            </div>
