...
function Index({ video_collection, pages, pornstarInformation, collageImages }) {
    ...
    return (
        <>
            <Head>
                <title>{`${capitalizeFirstLetter(pornstarname.replace('+', " ").replace("+", " "))} Porn Videos} - SpankBang`}</title>
                ...
                <link rel="canonical" href={`https://www.spankbang.gg/pornstar/${code}/${pornstarname}`} />
            </Head>
