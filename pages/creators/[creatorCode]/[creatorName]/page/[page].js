    ...
    return (
        <>
            ...
            <Head>
                ...
                <meta property="og:title" content={`${capitalizeFirstLetter(creatorData.creatorName.replace('+', " ").replace("+", " "))} Porn Videos - Spankbang`} />
                ...
                <meta name="twitter:title" content={`${capitalizeFirstLetter(creatorData.creatorName.replace('+', " ").replace("+", " "))} Porn Videos - Spankbang`} />
                ...
                <link rel="canonical" href={`https://www.Spankbang.gg/channels/${creatorName}/${creatorCode}`} />
            ...
            <div className="-mt-2 relative h-[240px] sm:h-[290px] md:h-[260px] lg:h-[290px] xl:h-[300px] 2xl:h-[350px] 3xl:h-[370px]">
                    <div>
                        ...
                        <div className='flex flex-col items-start mt-auto sm:mt-4 ml-[170px] lg:ml-[200px] 2xl:ml-[210px]'>
                            ...
                            <div className=''>
                                <span className='text-gray-400 font-poppins text-[12px] lg:text-[14px]'>Videos :  </span>
                                <span className='text-white font-poppins text-[12px] lg:text-[14px]'>  {creatorData.videosCount}</span>
                            </div>

                            <div>
                                <span className='text-gray-400 font-poppins text-[12px] lg:text-[14px]'>Views : </span>
                                <span className='text-white font-poppins text-[12px] lg:text-[14px]'>{creatorData.viewsCount}</span>
                            </div>

                            <div>
                                <span className='text-gray-400 font-poppins text-[12px] lg:text-[14px]'>Subscribers : </span>
                                <span className='text-white font-poppins text-[12px] lg:text-[14px]'>{creatorData.subscribersCount}</span>
                            </div>
                    ...
                    <div className=" absolute flex top-[60px] sm:top-[130px] md:top-[50px] lg:top-[50px] xl:top-[80px] 2xl:top-[120px] 3xl:top-[120px]  left-[10px] items-b justify-between w-[calc(100%-20px)]">
                        <div>
                            <img
                                ...
                                loading="lazy"
                            />
                            <h2 className="text-lg lg:text-xl 2xl:text-2xl font-poppins text-gray-300 my-1 pl-1">
                        ...
                        <div className="mt-auto flex flex-col space-y-4 ">
                            {creatorData.creatorHref &&
                                <Link href={creatorData.creatorHref} rel="nofollow">
                                    <div className="cursor-pointer h-fit flex items-center justify-center space-x-2 border-[1px] border-gray-300  px-3 lg:px-5 p-1.5 rounded-[20px] bg-semiblack text-white group">
                ...
                <p className='font-poppins text-gray-400 text-[14px] lg:text-[16px] px-3 mt-6 sm:mt-12 md:mt-0'>{creatorData.description}</p>
