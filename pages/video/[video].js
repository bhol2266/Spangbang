    ...
    return (
        <div>
            ...
            {preloadedVideoQuality.length > 0 && !noVideo ? (
                <>
                    <Head>
                        <title>{`${noVideo ? videoTitleBackup : videoDetails.Title}`} | SpankBang</title>
                        ...
                        <meta property="og:title" content={`${noVideo ? videoTitleBackup : videoDetails.Title}`} />
                        ...
                        <meta name="twitter:title" content={`${noVideo ? videoTitleBackup : videoDetails.Title}`} />
                    ...
                    <div className='py-1 rounded overflow-hidden sm:cursor-pointer '>
                        <VideoPlayer
                            ...
                            loggedIn={loggedIn}
                            relatedVideos={relatedVideos.slice(0, 4)}
