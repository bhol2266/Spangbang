...
function faq() {
    return (
        ...
        <div className=" m-2 border-2 border-gray-200 p-2 md:w-4/5 mx-auto">
            ...
            <h1 className="header">Uploading materials:</h1>
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                ...
                Yes, you can create an account. At the top of the page there is a link &quot;register&quot;. Account on MilfyMadness is free and we will NOT charge you anything.
            </details>


            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">I have uploaded material. When will it be visible?</summary>
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">Why did MilfyMadness delete my uploaded material?</summary>
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">My favorite video was deleted. Why?</summary>
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">How can I delete a video or photo?</summary>
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">MilfyMadness contains content with my participation without my consent.</summary>
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">I think I have found the wrong content. What should I do?</summary>
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">Can I buy ads on MilfyMadness?</summary>
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">Traffic from which geographical locations is prevalent?</summary>
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">How long can I buy ads for?
                </summary>
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">What advertising units are available?</summary>
            ...
            <h1 className="header">General questions:
            </h1>

            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">Who can use MilfyMadness?</summary>
                MilfyMadness can be used by persons who are at least 18 years old. If there are other legal regulations in your country, increasing age or restricting access, you should strictly follow them.            </details>


            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">Is the use of MilfyMadness free of charge?
                </summary>
                Yes, the use of MilfyMadness is completely free. We do not charge for anything and all the service functions are available free of charge.
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">Do you offer premium accounts?
                </summary>
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                ...
                We are always open to suggestions from users. Write us a message and tell us about your ideas on how to improve MilfyMadness. Thanks to such a suggestion we are getting better and better for you.
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                ...
                You can use MilfyMadness both on mobile, desktop and tablet devices. We support all modern browsers and all operating systems. However, if you find somewhere an error in operation on a given system, please inform us about it.

            </details>


            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">Video constantly buffer and jams. Why?
                </summary>
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">MilfyMadness in my country is being blocked. How to deal with it?
                </summary>
                Sometimes the internal regulations of a country block access to MilfyMadness content from that country. In the footer of the page you will find information on how to bypass such blocking.
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">What private data does the website collect?
                </summary>
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                ...
                Yes, MilfyMadness has several language versions and we are constantly working on adding more languages to our service. You can choose it in upper right corner of website.
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">I am a webmaster and I would like to place your materials on my website. What to do?
                </summary>
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">How can I search the site?
                </summary>
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">I want to become a Pornstar. What to do?
                </summary>
