    ...
    return (
        ...
        <div className=" m-2 border-2 border-gray-200 p-2 md:w-4/5 mx-auto">
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                ...
                Yes, you can create an account. At the top of the page there is a link &quot;register&quot;. Account on SpankBang is free and we will NOT charge you anything.
            </details>
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">Why did SpankBang delete my uploaded material?</summary>
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">SpankBang contains content with my participation without my consent.</summary>
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">Can I buy ads on SpankBang?</summary>
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">Who can use SpankBang?</summary>
                SpankBang can be used by persons who are at least 18 years old. If there are other legal regulations in your country, increasing age or restricting access, you should strictly follow them.            </details>


            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">Is the use of SpankBang free of charge?
                </summary>
                Yes, the use of SpankBang is completely free. We do not charge for anything and all the service functions are available free of charge.
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                ...
                We are always open to suggestions from users. Write us a message and tell us about your ideas on how to improve SpankBang. Thanks to such a suggestion we are getting better and better for you.
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                ...
                You can use SpankBang both on mobile, desktop and tablet devices. We support all modern browsers and all operating systems. However, if you find somewhere an error in operation on a given system, please inform us about it.
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                <summary className="font-semibold">SpankBang in my country is being blocked. How to deal with it?
                </summary>
                Sometimes the internal regulations of a country block access to SpankBang content from that country. In the footer of the page you will find information on how to bypass such blocking.
            ...
            <details className="border-2 border-gray-400 p-2 bg-gray-200 font-light cursor-pointer hover:bg-gray-300">
                ...
                Yes, SpankBang has several language versions and we are constantly working on adding more languages to our service. You can choose it in upper right corner of website.
